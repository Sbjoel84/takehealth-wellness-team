    ...
    <div className="p-6 lg:p-8 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatsCard
          ...
          description={`${stats?.patients?.new ?? 0} new this period`}
          icon={Users}
          trend={stats?.patients?.newDelta != null ? (stats.patients.newDelta >= 0 ? "up" : "down") : undefined}
          trendValue={stats?.patients?.newDelta != null ? `${Math.abs(stats.patients.newDelta)}%` : undefined}
        />
        <StatsCard
          title="Appointments"
        ...
        <StatsCard
          ...
          description={`${stats?.users?.new ?? 0} new this period`}
          icon={FileText}
        />
        <StatsCard
          title="Completed"
          ...
          icon={TrendingUp}
          trend={stats?.appointments?.completedDelta != null ? (stats.appointments.completedDelta >= 0 ? "up" : "down") : "up"}
          trendValue={stats?.appointments?.completedDelta != null ? `${Math.abs(stats.appointments.completedDelta)}%` : ""}
        />
      </div>
                ...
                {recentPatients.map((patient) => (
                  <div key={patient.id} className="flex items-center gap-4 p-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground truncate">{patient.phone || "No phone"}</p>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-medium capitalize">{patient.gender?.toLowerCase().replace("_", " ") || "—"}</p>
        ...
        <Card>
          ...
          <CardContent className="p-0">
            {loading ? (
                    ...
                    <div key={appointment.id} className="flex items-center gap-4 p-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground truncate">
                          {appointment.service?.name || appointment.type?.replace("_", " ") || "General"}
                        </p>
                      </div>
                      <div className="text-right">
              ...
              <div className="text-center py-8 text-muted-foreground">No recent appointments</div>
            )}
          </CardContent>
        </Card>
      </div>
